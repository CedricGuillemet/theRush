...
#define OBJECT_MATERIAL		0x4130			// This is found if the object has a material, either texture map or color !!!!! This is in fact per material face !!!!!
#define OBJECT_UV			0x4140			// The UV texture coordinates
#define OBJECT_SMOOTH_GROUP	0x4150			// This is too smooth normals only when required
#define OBJECT_TRANSFORM	0x4160			// local transforl
...
/*struct tFaceMaterialInfo
{
    int materialID;
    unsigned short* faceIds; 
};*/
...
private:
	...
	// This reads in the smooth groups
	void ReadSmoothGroups(t3DModel *pModel, t3DObject *pObject, tChunk *pPreviousChunk);
    
	// This reads in the smooth groups
	void ReadMeshTransform(t3DModel *pModel, t3DObject *pObject, tChunk *pPreviousChunk);
