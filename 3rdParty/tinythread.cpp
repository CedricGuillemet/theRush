...
//HACK: mhoulier (2012-10-25) custom change to tinythread code to disable warning locally
#pragma warning(push)
#pragma warning(disable:4530) //Disabling warning 4530: C++ exception handler used, but unwind semantics are not enabled. Specify /EHsc
  try
  {
